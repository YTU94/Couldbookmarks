...
<a href="/index.php?m=home&c=index&a=index" class="btn btn-large btn-primary" style="text-decoration: none;float: right;position: relative; top: 40px;right: 60px;">回到首页</a>
